...
// Optional
_APP_Publisher_URL = Mojo.appInfo.vendorurl // label = _APP_PublisherName + “Website”
_APP_Help_Resource = [
					 	{ type: 'web', label: 'Help Topics', url: 'http://www.bitsofgodsoftware.com/podFrenzy#help'},
						{ type: 'web', label: 'FAQ', url: 'http://www.bitsofgodsoftware.com/podFrenzy#faq'},
						//{ type : 'faq', label: $L('How-To Install a Bible'), sceneName: 'howtodload' },
						//{ type : 'faq', label: $L('How-To Read a Bible'), sceneName: 'howto' },
...
_APP_Support_URL = ''   // label = “Support Website”
_APP_Support_Email = {
	address: Mojo.appInfo.vendoremail,
	subject: 'Support Version '+Mojo.appInfo.version}        // label = “Send Email”
